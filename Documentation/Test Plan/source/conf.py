...
latex_documents = [
    ...
    ('test_plan', 'TestPlan.tex', 'Test Plan Pangeo by VRtualize',
     author, 'manual'),
    ('test_plan/repository_management', 'AppA.tex', 'Test Plan Pangeo by VRtualize',
     author, 'manual'),
    ('test_plan/issue_tracking_manager', 'AppB.tex', 'Test Plan Pangeo by VRtualize',
     author, 'manual'),
]
...
man_pages = [
    ...
    ('test_plan', 'TestPlan', 'Test Plan Pangeo by VRtualize',
     [author], 2),
    ('test_plan/repository_management', 'AppA', 'Repository Management',
     [author], 3),
    ('test_plan/issue_tracking_manager', 'AppB', 'Issue Tracking Manager',
     [author], 4)
]
