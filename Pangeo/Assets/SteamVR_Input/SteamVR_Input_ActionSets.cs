...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_PangeoControls p_PangeoControls;
        ...
        public static SteamVR_Input_ActionSet_PangeoControls PangeoControls
        {
            get
            {
                return SteamVR_Actions.p_PangeoControls.GetCopy<SteamVR_Input_ActionSet_PangeoControls>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_PangeoControls = ((SteamVR_Input_ActionSet_PangeoControls)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_PangeoControls>("/actions/PangeoControls")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.PangeoControls};
        }
    }
}
